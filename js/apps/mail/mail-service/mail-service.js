...
function _createMails() {
    ...
    // gMails.unshift(_createMail('', '', 'Nov 2'))
    // gMails.unshift(_createMail('', '', 'Nov 3'))
    // gMails.unshift(_createMail('', '', 'Nov 4'))
